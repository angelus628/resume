...
return [
    ...
    'sql_desc' => 'As a web developer I am constantly in contact with SQL, the language that allows programs to query the database for information. I can create intermediate level queries in POSTGRESQL, MYSQL and MSSQL (Microsoft SQL Server).',

    'frontend'      => 'Frontend Development',
    'frontend_desc' => 'As an integral part of web development, there is the frontend development which focuses on graphic interface usability and aesthetics. I have medium level knowledge in JavaScript, jQuery, HTML modeling.',
